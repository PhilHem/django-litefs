...
LITEFS = {
    ...
    "RAFT_SELF_ADDR": "localhost:4321",  # V2: This node's Raft address
    "RAFT_PEERS": [],                  # V2: List of peer Raft addresses
...
│       │   └── leader_election.py     # V2: Raft leader election (PySyncObj)
│       │
