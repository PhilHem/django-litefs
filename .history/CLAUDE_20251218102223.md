...
| Adapters (Django)  | django-litefs  | `litefs_django/`   | DB backend, settings reader, commands                |
| Adapters (FastAPI) | fastapi-litefs | `litefs_fastapi/`  | Middleware, routes (future)                          |
...
- [ ] `django-litefs` adapter: settings reader, DB backend
...
- [ ] `fastapi-litefs` adapter: middleware, routes
- [ ] Prometheus metrics
